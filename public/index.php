...
<html lang="en">
    ...
    <body class="text-center adm">
        <div class="container-sm">              
            ...
            <form class="form-signin" action="#" onsubmit="return checkall();">
            ...
            <div class="form-label-group">
                ...
                <input type="text" id="UserName" name="username" class="form-control" placeholder="Entre com o seu login" onkeyup="checkname();" required="" autofocus="">
                <span id="name_status"></span>
            </div>
            <div class="form-label-group">
                <label for="senha"></label>
                <input type="password" id="senha" class="form-control" placeholder="Entre com a sua senha" required="" autofocus="">
            </div>
        ...
        <script src="public/custom/login/verifyLogin.js" ></script>
